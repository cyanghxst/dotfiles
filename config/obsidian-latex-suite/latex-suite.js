[
    // Math mode {trigger: "mk", replacement: "$$0$", options: "tA"},
    ...
    // =========================
    // Derivatives (new snippets)
    // =========================

    // Ordinary derivatives (Leibniz)
    {
        trigger: "df",
        replacement: "\\frac{ \\mathrm{d}${0:y} }{ d${1:x} } $2",
        options: "mA",
        description: "dy/dx",
    },
    {
        trigger: "d2f",
        replacement: "\\frac{ \\mathrm{d}^{2} ${0:y} }{ d${1:x}^{2} } $2",
        options: "mA",
        description: "d^2y/dx^2",
    },
    {
        trigger: "d3f",
        replacement: "\\frac{ \\mathrm{d}^{3} ${0:y} }{ d${1:x}^{3} } $2",
        options: "mA",
    ...
    // {trigger: "pr2",  replacement: "${0:f}''(${1:x})$2", options: "mA", description: "f''(x)"},
    ...
    // {trigger: "pd2",  replacement: "\\frac{ \\partial^{2} ${0:f} }{ \\partial ${1:x}^{2} } $2", options: "mA", description: "∂^2 f / ∂x^2"},
    // {trigger: "pdm",  replacement: "\\frac{ \\partial^{2} ${0:f} }{ \\partial ${1:x} \\, \\partial ${2:y} } $3", options: "mA", description: "mixed partial ∂^2 f / ∂x∂y"},

    // // Partial operator form
    // {trigger: "Pdx",  replacement: "\\frac{ \\partial }{ \\partial ${0:x} } \\left( ${1:} \\right) $2", options: "mA", description: "∂/∂x (...)"},
    // {trigger: "Pdu",  replacement: "\\frac{ \\partial }{ \\partial ${0:u} } \\left( ${1:} \\right) $2", options: "mA", description: "∂/∂u (...)"},

    // // Gradient / Jacobian / Hessian
    // {trigger: "grad", replacement: "\\nabla ${0:f}(${1:\\mathbf{x}})$2", options: "mA", description: "gradient"},
    // {trigger: "Hess", replacement: "\\nabla^{2} ${0:f}(${1:\\mathbf{x}})$2", options: "mA", description: "Hessian"},
    // {trigger: "Jac",  replacement: "J_{${0:\\mathbf{f}}}(${1:\\mathbf{x}})$2", options: "mA", description: "Jacobian"},

    // // Directional derivative
    // {trigger: "dir",  replacement: "D_{ ${0:\\mathbf{u}} } \\, ${1:f}(${2:\\mathbf{x}})$3", options: "mA", description: "Directional derivative D_u f(x)"},

    // // Chain rule templates
    // {trigger: "chain1", replacement: "\\frac{ dy }{ dx } = \\frac{ dy }{ du } \\cdot \\frac{ du }{ dx }", options: "mA", description: "Single-variable chain rule"},
    // {trigger: "mchain", replacement: "\\frac{ d }{ dx } f\\big(u(x), v(x)\\big) = f_u \\, u'(x) + f_v \\, v'(x)", options: "mA", description: "Multivariable chain rule (2 args)"},

    // // Implicit differentiation template
    // {trigger: "impl", replacement: "\\text{If } F(x,y)=0,\\quad \\frac{dy}{dx} = -\\frac{ F_x }{ F_y }", options: "mA", description: "Implicit derivative"},

    // // Differentials / total derivative
    // {trigger: "totd", replacement: "d${0:y} = ${1:f_x} \\, d${2:x} + ${3:f_y} \\, d${4:y}$5", options: "mA", description: "Total differential (2 vars)"},
    // {trigger: "diff", replacement: "d${0:y}", options: "mA", description: "Differential dy"}
